...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pytest-django-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pytest-django-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pytest-django
# for installing globally
pixi global install pytest-django
```
...
It is possible to list all of the versions of `pytest-django` available on your platform:
...
```
pixi search pytest-django --channel conda-forge
```
